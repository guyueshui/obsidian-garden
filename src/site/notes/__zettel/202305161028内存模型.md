---
{"dg-publish":true,"permalink":"/zettel/202305161028/","title":202305161028,"tags":["cpp","memory-model","memory-order","memory-barrier","内存序"]}
---
...
正常理解，无论线程1，2的执行顺序如何，最后不可能出现打印出0，0的情况。但是在这种情况下，如果各自都从缓存中读数据，那就可能出现0，0的情况。这也进一步引出了[`volatile`](202304202149%20volatile%20specifier.md)关键字。
